...
|---|---|---|---|
| screens in `design/_nav.js` | 143 | 143 | 1 - `overview.html`, the coverage map, which describes the registry rather than standing in it |
...
Panels opened before the measurement: **3731** calls over 143 passes.
...
all 143 screens, because `wireframes/_nav.js` writes them into every page: auth-dialog, breadcrumb, button, cat-overlay, field, link-row, otp, toast.
Repeating them 143 times would bury what this table is for - what is
...
| `product-nodata.html` | 3.0 | 30 (від базового екрана product) | **29** - availability, badge, blog-card, buy-bar, buy-box, checkout-form, chip, city-dialog, desc-block, discount, empty-state, favourite, footer, gallery, header, mega-menu, nav-drawer, overlay, pdp-tabs, price, product-card, radio, rating, review-modal, section-head, spec-table, stack-action, tabbar, trust-strip |
| `product-noreviews.html` | 3.0 | 30 (від базового екрана product) | **31** - availability, badge, blog-card, buy-bar, buy-box, cert-thumb, checkout-form, chip, city-dialog, desc-block, discount, empty-state, favourite, footer, gallery, header, mega-menu, nav-drawer, overlay, pdp-tabs, price, product-card, qa-item, radio, rating, review-modal, section-head, spec-table, stack-action, tabbar, trust-strip |
...
|---|---|---|
| `chip` | 136 / 143 | `500`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
| `city-dialog` | 136 / 143 | `500`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
| `footer` | 131 / 143 | `500`, `auth`, `auth-code`, `auth-error`, `auth-loading`, `auth-newuser`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
| `header` | 136 / 143 | `500`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
| `mega-menu` | 136 / 143 | `500`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
| `nav-drawer` | 136 / 143 | `500`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
| `overlay` | 136 / 143 | `500`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
| `stack-action` | 136 / 143 | `500`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
| `tabbar` | 136 / 143 | `500`, `checkout`, `checkout-declined`, `checkout-loading`, `checkout-loggedin`, `checkout-noaddr`, `maintenance` |
...
| `auth-dialog` | 143 | `--bg-hatch` `--bg-page` `--bg-rule` `--bg-sunken` `--bg-surface` `--elevation-4` `--elevation-mark` `--fade-inverse` `--fade-page` `--line-action` `--line-danger` `--line-hair` `--line-onphoto` `--line-success` `--scrim-overlay` `--text-action` `--text-body` `--text-danger` `--text-muted` `--text-primary` `--text-secondary` `--text-success` `--veil-inverse` `--veil-page` | `--container-text` `--dur-cycle` `--dur-slow` `--ease-cycle` `--ease-enter` `--ease-exit` `--font-display` `--font-mono` `--fs-12` `--fs-14` `--fs-16` `--fs-18` `--fs-20` `--fs-24` `--fs-30` `--fs-34` `--fw-black` `--fw-bold` `--fw-semibold` `--lh-airy` `--lh-flat` `--ls-display` `--ls-eyebrow` `--ls-lead` `--move-md` `--radius-12` `--radius-16` `--radius-8` `--radius-circle` `--shell-left` `--shell-top` `--size-40` `--size-46` `--space-12` `--space-16` `--space-24` `--space-32` `--space-4` `--space-40` `--space-8` |
| `availability` | 38 | `--text-info` `--text-secondary` `--text-success` `--text-warning` | `--font-body` `--fs-12` `--fs-14` `--fw-bold` `--radius-circle` `--space-4` `--space-8` |
| `badge` | 25 | `--bg-action` `--bg-inverse` `--bg-page` `--elevation-mark` `--line-strong` `--text-action` `--text-onaction-ink` `--text-oninverse` `--text-primary` | `--fs-10` `--fw-black` `--lh-flat` `--lh-snug` `--ls-caps` `--radius-pill` `--space-12` `--space-2` `--space-4` `--space-8` |
...
| `blog-card` | 9 | `--bg-media` `--bg-page` `--bg-sunken` `--elevation-1` `--elevation-2` `--line-hair` `--text-body` `--text-onmedia` `--text-primary` `--text-secondary` | `--container-text` `--dur-fast` `--ease-standard` `--fs-12` `--fs-14` `--fs-16` `--fw-black` `--fw-bold` `--grid-col-min-panel` `--grid-gap-fluid` `--lh-airy` `--lh-snug` `--radius-12` `--radius-pill` `--space-12` `--space-16` `--space-2` `--space-24` `--space-4` `--space-8` |
...
| `breadcrumb` | 143 | `--mark-disabled` `--ring-focus-control` `--text-action` `--text-muted` `--text-primary` | `--dur-fast` `--ease-standard` `--fs-12` `--fw-bold` `--radius-4` `--space-12` `--space-16` `--space-8` |
| `button` | 143 | `--bg-action` `--bg-action-pressed` `--bg-action-soft` `--bg-danger` `--bg-danger-soft` `--bg-page` `--bg-sunken` `--bg-surface` `--elevation-control` `--line-action` `--line-danger` `--line-hair` `--line-strong` `--mark-disabled` `--ring-focus-control` `--text-action` `--text-body` `--text-danger` `--text-muted` `--text-onaction` `--text-secondary` | `--dur-fast` `--ease-standard` `--fs-14` `--fs-16` `--fs-18` `--fw-bold` `--lh-snug` `--radius-12` `--radius-8` `--size-20` `--size-24` `--size-40` `--size-44` `--size-52` `--size-64` `--space-12` `--space-16` `--space-24` `--space-4` `--space-8` |
| `buy-bar` | 5 | `--bg-page` `--elevation-bar-top` `--line-hair` `--text-body` | `--fs-12` `--fs-20` `--lh-flat` `--space-12` `--space-16` `--space-8` |
| `buy-box` | 5 | `--bg-inverse` `--bg-page` `--bg-save` `--bg-sunken` `--bg-surface` `--line-hair` `--line-inverse` `--mark-inactive` `--text-action` `--text-body` `--text-danger` `--text-muted` `--text-primary` `--text-secondary` `--text-success` | `--container-text` `--font-body` `--font-display` `--font-mono` `--fs-10` `--fs-12` `--fs-14` `--fs-30` `--fw-black` `--fw-bold` `--fw-regular` `--fw-semibold` `--lh-airy` `--lh-flat` `--lh-snug` `--ls-caps` `--ls-display` `--ls-lead` `--radius-12` `--radius-16` `--radius-4` `--radius-8` `--size-34` `--space-12` `--space-16` `--space-2` `--space-24` `--space-4` `--space-8` |
...
| `cat-overlay` | 143 | `--bg-page` `--bg-surface` `--line-hair` `--mark-faint` `--text-action` `--text-body` `--text-muted` `--text-primary` `--text-secondary` | `--dur-slow` `--ease-enter` `--ease-exit` `--fs-12` `--fs-14` `--fs-16` `--fs-18` `--fs-20` `--fw-black` `--fw-bold` `--fw-semibold` `--lh-flat` `--lh-snug` `--shell-top` `--size-24` `--space-12` `--space-16` `--space-2` `--space-24` `--space-4` |
| `cert-thumb` | 5 | `--bg-media` `--bg-page` `--bg-rule` `--line-action` `--line-hair` `--line-media` `--line-strong` `--text-body` `--text-muted` `--text-onmedia` `--text-primary` `--text-secondary` | `--container-text` `--dur-fast` `--ease-standard` `--font-mono` `--fs-10` `--fs-12` `--fs-14` `--fw-bold` `--fw-semibold` `--grid-col-fluid` `--grid-gap-fluid` `--lh-flat` `--ls-caps` `--radius-12` `--radius-4` `--radius-8` `--radius-pill` `--space-12` `--space-16` `--space-2` `--space-4` `--space-8` |
...
| `desc-block` | 4 | `--bg-page` `--line-hair` `--text-body` `--text-muted` `--text-primary` | `--container-text` `--fs-16` `--lh-airy` `--radius-12` `--space-12` `--space-32` |
| `discount` | 25 | `--bg-discount` `--bg-sunken` `--text-danger` `--text-secondary` | `--font-body` `--font-mono` `--fs-10` `--fs-12` `--fw-black` `--fw-bold` `--fw-semibold` `--lh-flat` `--radius-4` `--space-2` `--space-4` `--space-8` |
| `empty-state` | 31 | `--bg-danger-soft` `--bg-surface` `--line-danger-soft` `--line-hair` `--line-strong` `--text-action` `--text-body` `--text-danger` `--text-muted` `--text-primary` `--text-secondary` | `--font-display` `--fs-12` `--fs-14` `--fs-16` `--fs-18` `--fs-20` `--fs-24` `--fs-30` `--fw-black` `--fw-semibold` `--lh-airy` `--radius-12` `--radius-circle` `--size-34` `--space-12` `--space-16` `--space-24` `--space-4` `--space-40` `--space-8` |
...
| `footer` | 131 | `--bg-page` `--bg-surface` `--line-hair` `--text-action` `--text-muted` `--text-primary` `--text-secondary` | `--container-page` `--dur-fast` `--ease-standard` `--fs-12` `--fs-14` `--fs-24` `--fw-black` `--lh-airy` `--lh-flat` `--ls-caps` `--ls-display` `--radius-12` `--size-24` `--space-12` `--space-16` `--space-2` `--space-24` `--space-32` `--space-4` `--space-8` |
| `gallery` | 6 | `--bg-photo` `--bg-photo-far` `--bg-photo-mark` `--bg-sunken` `--elevation-mark` `--fade-photo` `--line-action` `--line-hair` `--mark-faint` `--shadow-floor` `--text-action` `--text-photo-mark` | `--dur-fast` `--ease-standard` `--fs-10` `--fw-black` `--lh-flat` `--ls-caps` `--radius-16` `--radius-8` `--radius-pill` `--space-12` `--space-4` `--space-8` |
...
| `link-row` | 143 | `--line-strong` `--ring-focus-control` `--text-action` `--text-body` `--text-secondary` | `--dur-fast` `--ease-standard` `--fs-14` `--fw-bold` `--radius-4` `--size-44` `--space-16` |
...
| `mega-menu` | 136 | `--bg-page` `--bg-surface` `--line-action` `--line-hair` `--line-strong` `--mark-faint` `--text-action` `--text-body` `--text-muted` `--text-primary` `--text-secondary` | `--dur-fast` `--ease-standard` `--fs-12` `--fs-14` `--fs-18` `--fw-black` `--fw-bold` `--fw-semibold` `--lh-snug` `--radius-8` `--size-24` `--space-12` `--space-16` `--space-2` `--space-24` `--space-4` `--space-8` |
...
| `nav-drawer` | 136 | `--bg-page` `--elevation-3` `--line-hair` `--text-body` `--text-muted` `--text-primary` `--text-secondary` | `--dr-top` `--dur-base` `--dur-slow` `--ease-enter` `--ease-exit` `--fs-12` `--fs-14` `--fs-16` `--fw-black` `--fw-bold` `--fw-semibold` `--ls-caps` `--size-20` `--space-12` `--space-16` `--space-2` `--space-32` `--space-8` |
...
| `otp` | 143 | `--bg-danger` `--bg-page` `--line-action` `--line-danger` `--line-danger-soft` `--line-inverse` `--line-strong` `--ring-focus` `--text-body` `--text-danger` `--text-secondary` | `--dur-fast` `--ease-standard` `--font-mono` `--fs-12` `--fs-14` `--fs-16` `--fs-24` `--fw-medium` `--fw-semibold` `--lh-flat` `--radius-12` `--space-12` `--space-16` `--space-2` `--space-4` `--space-8` |
| `overlay` | 136 | `--scrim-overlay` | `--dur-slow` `--ease-enter` `--ease-exit` `--space-24` |
| `pagination` | 12 | `--bg-action` `--text-onaction` | `--space-16` `--space-24` `--space-8` |
| `pdp-tabs` | 10 | `--bg-action` `--bg-inverse` `--bg-page` `--elevation-2` `--line-hair` `--text-body` `--text-onaction` `--text-oninverse` `--text-secondary` | `--dur-fast` `--ease-standard` `--fs-12` `--fs-14` `--fs-16` `--fs-20` `--fw-black` `--fw-bold` `--fw-semibold` `--lh-flat` `--radius-4` `--radius-8` `--shelf-h` `--shelf-top` `--space-12` `--space-16` `--space-2` `--space-24` `--space-40` `--space-8` |
...
| `price` | 62 | `--text-action` `--text-body` `--text-muted` | `--font-mono` `--fw-black` `--fw-regular` |
| `product-card` | 34 | `--bg-media` `--bg-page` `--elevation-1` `--elevation-2` `--line-action` `--line-hair` `--mark-faint` `--text-action` `--text-body` `--text-bonus` `--text-brandline` `--text-primary` `--text-secondary` | `--dur-fast` `--ease-standard` `--font-mono` `--fs-10` `--fs-12` `--fs-14` `--fs-16` `--fs-18` `--fs-20` `--fs-24` `--fs-8` `--fw-black` `--fw-bold` `--fw-semibold` `--lh-flat` `--lh-snug` `--ls-lead` `--move-sm` `--radius-12` `--radius-8` `--size-20` `--size-44` `--space-12` `--space-16` `--space-2` `--space-4` `--space-8` |
...
| `qa-item` | 5 | `--bg-surface` `--line-action` `--line-hair` `--text-body` `--text-primary` | `--container-text` `--fs-14` `--fs-16` `--fw-bold` `--radius-8` `--space-12` `--space-16` `--space-8` |
...
| `radio` | 16 | `--bg-action` `--bg-action-soft` `--bg-page` `--line-action` `--line-hair` `--line-inverse` `--line-strong` `--ring-focus-control` `--text-body` `--text-muted` `--text-primary` `--text-secondary` | `--dur-fast` `--ease-standard` `--font-mono` `--fs-12` `--fs-14` `--fw-bold` `--fw-medium` `--fw-semibold` `--radius-12` `--radius-8` `--radius-circle` `--space-12` `--space-16` `--space-2` `--space-4` `--space-8` |
| `rating` | 36 | `--line-action` `--mark-inactive` `--mark-rating` `--text-body` `--text-muted` | `--dur-fast` `--ease-standard` `--font-mono` `--fs-12` `--fs-14` `--fs-30` `--fw-bold` `--lh-flat` `--radius-4` `--space-2` `--space-4` `--space-8` |
...
| `section-head` | 30 | `--bg-surface` `--line-hair` `--text-action` `--text-body` `--text-muted` `--text-primary` `--text-secondary` | `--dur-fast` `--ease-standard` `--font-display` `--fs-12` `--fs-16` `--fs-24` `--fs-display` `--fw-black` `--fw-bold` `--fw-medium` `--fw-semibold` `--ls-caps` `--ls-display` `--ls-lead` `--radius-8` `--space-12` `--space-16` `--space-24` `--space-32` `--space-4` `--space-8` |
...
| `tabbar` | 136 | `--bg-action` `--bg-page` `--elevation-bar-top` `--line-hair` `--text-body` `--text-secondary` | `--fw-black` `--radius-4` `--size-26` `--space-2` `--space-4` `--space-8` |
| `toast` | 143 | `--bg-inverse` `--bg-page` `--elevation-4` `--line-onink` `--text-oninverse` `--text-primary` | `--dur-base` `--dur-slow` `--ease-enter` `--ease-exit` `--fs-12` `--fs-14` `--fw-black` `--move-md` `--move-sm` `--radius-8` `--radius-circle` `--size-20` `--space-12` `--space-16` `--space-8` |
...
|---|---|---|
| `--bg-action` | account-shell, badge, banner, button, checkbox, checkout-form, chip, coach-cabinet, coach-verify, loyalty-rung, pagination, pdp-tabs, price-slider, quiz, radio, stack-action, switch, tabbar, toolbar, trust-strip, upsell | **143** |
| `--bg-action-hover` | goal-tile | catalog-page, home-buyer, home-cart, home-coach, index, search-empty |
| `--bg-action-pressed` | button, checkbox, chip | **143** |
| `--bg-action-selected` | view-toggle | **13** |
| `--bg-action-soft` | button, checkbox, checkout-form, chip, radio, stack-action, stepper, view-toggle | **143** |
| `--bg-bonus-soft` | loyalty-rung, order-row, status-pill | **53** |
| `--bg-danger` | button, otp | **143** |
| `--bg-danger-soft` | button, empty-state | **143** |
| `--bg-discount` | discount | **25** |
| `--bg-hatch` | auth-dialog, coach-landing, header | **143** |
| `--bg-inverse` | badge, buy-box, checkout-form, client-row, coach-landing, cookie-banner, header, info-page, loyalty-rung, pdp-tabs, review-item, spec-table, toast | **143** |
| `--bg-inverse-soft` | spec-table | product, product-coach, product-nodata, product-noreviews |
| `--bg-inverse-tint` | spec-table | product, product-coach, product-nodata, product-noreviews |
| `--bg-media` | blog-card, cert-thumb, contacts-block, hero, product-card, promo-card | **38** |
| `--bg-notice` | checkout-form, quiz, spec-table | **43** |
| `--bg-onphoto` | trust-strip | **7** |
...
| `--bg-photo` | gallery | product, product-coach, product-loading, product-nodata, product-noreviews, product-oos |
| `--bg-photo-far` | gallery | product, product-coach, product-loading, product-nodata, product-noreviews, product-oos |
| `--bg-photo-mark` | gallery | product, product-coach, product-loading, product-nodata, product-noreviews, product-oos |
| `--bg-rule` | auth-dialog, cert-thumb, checkout-form, menu, review-item | **143** |
| `--bg-save` | buy-box | product, product-coach, product-nodata, product-noreviews, product-oos |
| `--bg-success` | **нікого** | **0** |
...
| `--bg-surface` | account-shell, address-card, auth-dialog, banner, button, buy-box, cart-drawer, cat-overlay, checkout-form, client-row, coach-cabinet, coach-landing, coach-order, coach-session, coach-verify, empty-state, faq-page, field, filter-rail, footer, header, info-page, loyalty-rung, mega-menu, order-placed, order-row, plan-card, qa-item, review-item, review-modal, search-overlay, section-head, spec-table, status-pill, stepper, trust-strip, upsell, view-toggle | **143** |
| `--bg-track` | banner, checkout-form, price-slider, quiz, switch | **51** |
| `--bg-warning` | cart-drawer, checkout-form | **47** |
| `--elevation-1` | account-shell, address-card, article, banner, blog-card, cart-drawer, checkout-form, coach-clients, filter-rail, goal-tile, hero, loyalty-rung, nav-tile, newsletter, order-row, product-card, promo-card, skeleton, trust-strip | **114** |
| `--elevation-2` | banner, blog-card, goal-tile, hero, pdp-tabs, product-card, promo-card | **39** |
| `--elevation-3` | filter-rail, header, menu, nav-drawer | **136** |
| `--elevation-4` | auth-dialog, city-dialog, client-dialog, cookie-banner, menu, quiz, review-modal, search-overlay, toast | **143** |
| `--elevation-action-hover` | header | **136** |
| `--elevation-bar-bottom` | header | **136** |
| `--elevation-bar-top` | buy-bar, cart-drawer, cookie-banner, tabbar | **136** |
| `--elevation-control` | button, trust-strip | **143** |
| `--elevation-drawer` | cart-drawer | cart, cart-coach, cart-coach-empty, cart-empty, cart-oos |
| `--elevation-knob` | checkout-form, price-slider | **49** |
| `--elevation-knob-active` | price-slider | **13** |
| `--elevation-mark` | auth-dialog, badge, gallery | **143** |
| `--fade-inverse` | auth-dialog | **143** |
| `--fade-page` | auth-dialog, spec-table | **143** |
| `--fade-photo` | gallery | product, product-coach, product-loading, product-nodata, product-noreviews, product-oos |
| `--fade-surface` | banner, hero | **11** |
| `--field-caret` | field | **143** |
...
| `--line-control-filled` | field | **143** |
| `--line-control-hover` | field, stepper | **143** |
| `--line-danger` | auth-dialog, button, checkout-form, coach-verify, field, otp | **143** |
| `--line-danger-soft` | empty-state, otp | **143** |
...
| `--line-inverse` | address-card, buy-box, checkout-form, city-dialog, client-dialog, client-row, coach-cabinet, coach-clients, coach-landing, coach-session, coach-tariff, cookie-banner, filter-rail, header, otp, plan-card, radio, spec-table, trust-strip | **143** |
| `--line-media` | cert-thumb, contacts-block, hero | **15** |
| `--line-notice` | cart-drawer, checkout-form, quiz, spec-table | **48** |
| `--line-onaction` | account-shell, checkbox, coach-cabinet, price-slider | **62** |
| `--line-onink` | toast | **143** |
| `--line-oninverse-soft` | client-row, spec-table | **10** |
| `--line-onphoto` | auth-dialog | **143** |
| `--line-strong` | account-shell, address-card, article, badge, button, cart-drawer, cert-thumb, checkbox, checkout-form, chip, city-dialog, client-dialog, coach-cabinet, coach-clients, coach-order, coach-session, coach-verify, coach-wishlist, cookie-banner, empty-state, faq-page, field, goal-tile, header, info-page, link-row, loyalty-rung, mega-menu, menu, nav-tile, newsletter, order-placed, order-row, otp, quiz, radio, related, search-overlay, spec-table, status-pill, stepper, toolbar, view-toggle | **143** |
| `--line-success` | auth-dialog, coach-verify, order-placed | **143** |
| `--line-success-soft` | coach-verify, order-placed, status-pill | **21** |
| `--line-warning` | checkout-form | **42** |
| `--mark-disabled` | breadcrumb, button, field, stepper | **143** |
| `--mark-faint` | account-shell, address-card, cat-overlay, coach-landing, filter-rail, gallery, header, mega-menu, order-row, product-card, product-thumb, search-overlay | **143** |
| `--mark-inactive` | buy-box, rating | **36** |
| `--mark-rating` | checkout-form, rating | **45** |
| `--mark-tier-bronze` | loyalty-rung | **39** |
| `--mark-tier-silver` | loyalty-rung | **39** |
| `--ring-danger` | field | **143** |
| `--ring-focus` | coach-clients, field, header, otp, stepper | **143** |
| `--ring-focus-control` | breadcrumb, button, checkbox, chip, coach-clients, filter-group, link-row, menu, radio, stack-action, switch | **143** |
| `--ring-onink` | stack-action | **136** |
| `--scrim-overlay` | auth-dialog, cart-drawer, filter-rail, filter-sheet, header, menu, overlay, search-overlay | **143** |
| `--shadow-floor` | gallery | product, product-coach, product-loading, product-nodata, product-noreviews, product-oos |
...
| `--text-bonus` | checkout-form, loyalty-rung, order-row, product-card | **68** |
| `--text-brandline` | banner, cart-row, product-card | **46** |
| `--text-danger` | account-shell, auth-dialog, button, buy-box, checkout-form, coach-verify, discount, empty-state, header, otp, review-modal | **143** |
| `--text-info` | availability | **38** |
...
| `--text-onaction` | banner, button, coach-cabinet, coach-verify, pagination, pdp-tabs | **143** |
| `--text-onaction-ink` | account-shell, badge, chip, stack-action, toolbar, trust-strip | **136** |
| `--text-oninverse` | badge, checkout-form, client-row, coach-landing, header, info-page, pdp-tabs, spec-table, toast | **143** |
| `--text-oninverse-muted` | client-row, spec-table | **10** |
| `--text-onmedia` | blog-card, cert-thumb, contacts-block, hero, promo-card | **18** |
| `--text-onmedia-muted` | hero | **9** |
| `--text-photo-mark` | gallery | product, product-coach, product-loading, product-nodata, product-noreviews, product-oos |
...
| `--text-success` | auth-dialog, availability, buy-box, checkout-form, coach-verify, loyalty-rung, order-placed, status-pill | **143** |
| `--text-warning` | account-shell, availability, cart-drawer, checkout-form, loyalty-rung, order-row, spec-table, status-pill | **97** |
| `--veil-inverse` | auth-dialog | **143** |
| `--veil-page` | auth-dialog | **143** |
...
|---|---|---|
| `--amber-200` | `--line-notice` | **48** |
| `--amber-50` | `--bg-warning` `--bg-notice` | **48** |
| `--amber-500` | `--text-warning` `--text-bonus` `--line-warning` | **98** |
| `--amber-700` | `--text-warning` `--text-bonus` `--line-warning` | **98** |
| `--amber-800` | `--line-notice` | **48** |
| `--amber-950` | `--bg-warning` `--bg-notice` | **48** |
| `--bp-grid-2col` | **нікого** | **0** |
| `--bp-shell-wide` | **нікого** | **0** |
| `--brown-600` | `--mark-tier-bronze` | **39** |
| `--charcoal` | `--text-primary` `--text-body` `--text-oninverse` `--text-onaction-ink` `--bg-inverse` `--bg-media` `--line-media` `--line-inverse` + 2 more | **143** |
| `--container-page` | *component cart-drawer.css* *component checkout-form.css* *component coach-session.css* *component footer.css* *component header.css* | **141** |
| `--container-text` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component blog-card.css* *component buy-box.css* *component cart-drawer.css* *component cert-thumb.css* + 23 more | **143** |
| `--dur-base` | *component coach-clients.css* *component filter-rail.css* *component header.css* *component menu.css* *component nav-drawer.css* *component order-row.css* *component quiz.css* *component toast.css* | **143** |
| `--dur-cycle` | *component auth-dialog.css* *component checkout-form.css* *component skeleton.css* | **143** |
| `--dur-fast` | *component account-shell.css* *component article.css* *component banner.css* *component blog-card.css* *component brand-logo.css* *component breadcrumb.css* *component button.css* *component cart-row.css* + 43 more | **143** |
| `--dur-slow` | *component auth-dialog.css* *component cat-overlay.css* *component city-dialog.css* *component cookie-banner.css* *component filter-sheet.css* *component header.css* *component nav-drawer.css* *component overlay.css* + 2 more | **143** |
| `--ease-cycle` | *component auth-dialog.css* *component checkout-form.css* *component skeleton.css* | **143** |
| `--ease-enter` | *component auth-dialog.css* *component cat-overlay.css* *component city-dialog.css* *component coach-clients.css* *component cookie-banner.css* *component filter-rail.css* *component filter-sheet.css* *component header.css* + 6 more | **143** |
| `--ease-exit` | *component auth-dialog.css* *component cat-overlay.css* *component city-dialog.css* *component cookie-banner.css* *component filter-rail.css* *component filter-sheet.css* *component header.css* *component menu.css* + 5 more | **143** |
| `--ease-standard` | *component account-shell.css* *component article.css* *component banner.css* *component blog-card.css* *component brand-logo.css* *component breadcrumb.css* *component button.css* *component cart-row.css* + 42 more | **143** |
| `--fade-dark-0` | `--fade-page` | **143** |
| `--fade-ink-0` | `--fade-photo` `--fade-inverse` | **143** |
| `--fade-light-0` | `--fade-inverse` | **143** |
| `--fade-surface-dark-0` | `--fade-surface` | **11** |
| `--fade-warm-0` | `--fade-surface` | **11** |
| `--fade-white-0` | `--fade-page` | **143** |
| `--font-body` | *component availability.css* *component buy-box.css* *component client-row.css* *component discount.css* *component loyalty-rung.css* | **79** |
| `--font-display` | *component account-shell.css* *component auth-dialog.css* *component banner.css* *component buy-box.css* *component cart-drawer.css* *component checkout-form.css* *component client-row.css* *component coach-clients.css* + 13 more | **143** |
| `--font-mono` | *component account-shell.css* *component auth-dialog.css* *component banner.css* *component buy-box.css* *component cart-drawer.css* *component cert-thumb.css* *component checkout-form.css* *component client-row.css* + 19 more | **143** |
| `--fs-10` | *component address-card.css* *component badge.css* *component buy-box.css* *component cart-row.css* *component cert-thumb.css* *component checkout-form.css* *component discount.css* *component gallery.css* + 9 more | **141** |
| `--fs-12` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component availability.css* *component banner.css* *component blog-card.css* *component breadcrumb.css* + 58 more | **143** |
| `--fs-14` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component availability.css* *component banner.css* *component blog-card.css* *component brand-logo.css* + 61 more | **143** |
| `--fs-16` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component banner.css* *component blog-card.css* *component button.css* *component cart-drawer.css* + 35 more | **143** |
| `--fs-18` | *component address-card.css* *component article.css* *component auth-dialog.css* *component banner.css* *component button.css* *component cat-overlay.css* *component city-dialog.css* *component client-dialog.css* + 15 more | **143** |
| `--fs-20` | *component account-shell.css* *component article.css* *component auth-dialog.css* *component banner.css* *component buy-bar.css* *component cart-drawer.css* *component cart-row.css* *component cat-overlay.css* + 19 more | **143** |
| `--fs-24` | *component address-card.css* *component auth-dialog.css* *component banner.css* *component cart-drawer.css* *component checkout-form.css* *component client-dialog.css* *component client-row.css* *component coach-cabinet.css* + 16 more | **143** |
| `--fs-30` | *component auth-dialog.css* *component banner.css* *component buy-box.css* *component checkout-form.css* *component coach-clients.css* *component coach-verify.css* *component empty-state.css* *component order-placed.css* + 2 more | **143** |
| `--fs-34` | *component auth-dialog.css* *component coach-landing.css* *component info-page.css* *component system-page.css* | **143** |
| `--fs-8` | *component coach-clients.css* *component coach-session.css* *component order-placed.css* *component order-row.css* *component product-card.css* *component trust-strip.css* | **57** |
| `--fs-display` | *component account-shell.css* *component checkout-form.css* *component section-head.css* | **80** |
| `--fw-black` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component badge.css* *component banner.css* *component blog-card.css* *component buy-box.css* + 49 more | **143** |
| `--fw-bold` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component availability.css* *component banner.css* *component blog-card.css* *component brand-logo.css* + 51 more | **143** |
| `--fw-medium` | *component banner.css* *component cart-drawer.css* *component cart-row.css* *component checkout-form.css* *component client-row.css* *component cookie-banner.css* *component menu.css* *component otp.css* + 4 more | **143** |
| `--fw-regular` | *component buy-box.css* *component coach-order.css* *component order-placed.css* *component price.css* | **64** |
| `--fw-semibold` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component banner.css* *component buy-box.css* *component cart-drawer.css* *component cart-row.css* + 40 more | **143** |
| `--gold-500` | `--mark-rating` | **45** |
| `--green-400` | `--text-success` `--line-success` | **143** |
| `--green-50` | `--bg-success` | **0** |
| `--green-600` | `--text-success` `--line-success` | **143** |
| `--green-950` | `--bg-success` | **0** |
| `--grey-24` | `--bg-inverse-soft` | **4** |
| `--grey-aa` | `--text-price-was` | **0** |
| `--grey-bb` | `--mark-faint` | **143** |
| `--grey-cc` | `--mark-disabled` | **143** |
| `--grid-col-fluid` | *component cert-thumb.css* *component info-page.css* *component nav-tile.css* *component product-grid.css* *component skeleton.css* | **28** |
| `--grid-col-min` | *component article.css* *component cert-thumb.css* *component info-page.css* *component nav-tile.css* *component product-grid.css* *component skeleton.css* | **29** |
| `--grid-col-min-narrow` | *component cert-thumb.css* *component info-page.css* *component nav-tile.css* *component product-grid.css* *component skeleton.css* | **28** |
| `--grid-col-min-panel` | *component address-card.css* *component blog-card.css* *component info-page.css* *component loyalty-rung.css* *component promo-card.css* | **53** |
| `--grid-gap-fluid` | *component article.css* *component blog-card.css* *component cert-thumb.css* *component info-page.css* *component nav-tile.css* *component product-grid.css* *component promo-card.css* *component skeleton.css* | **36** |
| `--lh-airy` | *component address-card.css* *component article.css* *component auth-dialog.css* *component banner.css* *component blog-card.css* *component buy-box.css* *component cart-drawer.css* *component checkout-form.css* + 26 more | **143** |
| `--lh-flat` | *component account-shell.css* *component auth-dialog.css* *component badge.css* *component banner.css* *component buy-bar.css* *component buy-box.css* *component cart-drawer.css* *component cat-overlay.css* + 18 more | **143** |
| `--lh-snug` | *component article.css* *component badge.css* *component banner.css* *component blog-card.css* *component button.css* *component buy-box.css* *component cart-row.css* *component cat-overlay.css* + 20 more | **143** |
| `--ls-caps` | *component account-shell.css* *component address-card.css* *component badge.css* *component banner.css* *component buy-box.css* *component cert-thumb.css* *component checkout-form.css* *component city-dialog.css* + 19 more | **141** |
| `--ls-display` | *component auth-dialog.css* *component buy-box.css* *component checkout-form.css* *component coach-verify.css* *component footer.css* *component header.css* *component section-head.css* *component system-page.css* | **143** |
| `--ls-eyebrow` | *component auth-dialog.css* *component banner.css* *component checkout-form.css* | **143** |
| `--ls-lead` | *component account-shell.css* *component auth-dialog.css* *component banner.css* *component buy-box.css* *component cart-drawer.css* *component checkout-form.css* *component client-row.css* *component coach-clients.css* + 15 more | **143** |
| `--move-md` | *component auth-dialog.css* *component city-dialog.css* *component coach-clients.css* *component cookie-banner.css* *component filter-rail.css* *component review-modal.css* *component toast.css* | **143** |
| `--move-sm` | *component product-card.css* *component review-modal.css* *component toast.css* | **143** |
| `--orange-25` | `--bg-action-soft` | **143** |
| `--orange-50` | `--bg-action-hover` | **6** |
| `--orange-500` | `--text-action` `--bg-action` `--line-action` | **143** |
| `--orange-600` | `--bg-action-pressed` | **143** |
| `--orange-700` | `--bg-action-pressed` | **143** |
| `--orange-900` | `--bg-action-hover` | **6** |
| `--orange-950` | `--bg-action-soft` | **143** |
| `--radius-12` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component banner.css* *component blog-card.css* *component brand-logo.css* *component button.css* + 43 more | **143** |
| `--radius-16` | *component auth-dialog.css* *component banner.css* *component buy-box.css* *component checkout-form.css* *component client-row.css* *component coach-landing.css* *component coach-verify.css* *component filter-sheet.css* + 10 more | **143** |
| `--radius-4` | *component breadcrumb.css* *component buy-box.css* *component cert-thumb.css* *component checkbox.css* *component coach-clients.css* *component contacts-block.css* *component discount.css* *component filter-group.css* + 10 more | **143** |
| `--radius-8` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component button.css* *component buy-box.css* *component cart-row.css* *component cert-thumb.css* + 36 more | **143** |
| `--radius-circle` | *component account-shell.css* *component auth-dialog.css* *component availability.css* *component banner.css* *component cart-drawer.css* *component checkout-form.css* *component client-dialog.css* *component coach-cabinet.css* + 15 more | **143** |
| `--radius-pill` | *component account-shell.css* *component badge.css* *component blog-card.css* *component cert-thumb.css* *component checkout-form.css* *component chip.css* *component city-dialog.css* *component coach-cabinet.css* + 15 more | **141** |
| `--red-400` | `--text-danger` `--line-danger` | **143** |
| `--red-50` | `--bg-danger` `--bg-discount` `--bg-save` | **143** |
| `--red-600` | `--text-danger` `--line-danger` | **143** |
| `--red-950` | `--bg-danger` `--bg-discount` `--bg-save` | **143** |
| `--scrim-black-12` | `--elevation-1` `--elevation-3` | **141** |
| `--scrim-black-22` | `--elevation-1` `--elevation-2` `--elevation-4` `--elevation-control` `--elevation-bar-top` `--elevation-bar-bottom` | **143** |
| `--scrim-black-40` | `--elevation-3` `--elevation-mark` `--elevation-knob` | **143** |
| `--scrim-black-52` | `--elevation-4` `--elevation-drawer` `--scrim-overlay` | **143** |
| `--scrim-ink-07` | `--elevation-control` `--elevation-bar-top` `--elevation-bar-bottom` `--shadow-floor` | **143** |
| `--scrim-ink-10` | `--elevation-2` `--bg-inverse-tint` *component quiz.css* | **39** |
| `--scrim-ink-16` | `--elevation-mark` | **143** |
| `--scrim-ink-22` | `--elevation-knob` `--elevation-drawer` `--line-oninverse-soft` | **55** |
| `--scrim-ink-52` | `--scrim-overlay` | **143** |
| `--scrim-ink-75` | `--text-oninverse-muted` | **10** |
| `--scrim-white-10` | `--bg-inverse-tint` | **4** |
| `--scrim-white-20` | `--line-oninverse-soft` | **10** |
| `--scrim-white-50` | `--line-onphoto` | **143** |
| `--scrim-white-66` | `--text-onmedia-muted` `--text-oninverse-muted` | **15** |
| `--scrim-white-70` | **нікого** | **0** |
| `--scrim-white-94` | `--bg-onphoto` | **7** |
| `--shadow-1` | `--elevation-1` | **114** |
| `--size-20` | *component account-shell.css* *component button.css* *component contacts-block.css* *component field.css* *component goal-tile.css* *component header.css* *component info-page.css* *component menu.css* + 8 more | **143** |
| `--size-24` | *component button.css* *component cat-overlay.css* *component checkout-form.css* *component cookie-banner.css* *component footer.css* *component mega-menu.css* *component skeleton.css* | **143** |
| `--size-26` | *component checkout-form.css* *component goal-tile.css* *component loyalty-rung.css* *component spec-table.css* *component switch.css* *component tabbar.css* | **141** |
| `--size-30` | *component coach-landing.css* *component faq-page.css* *component order-row.css* *component quiz.css* *component skeleton.css* *component stepper.css* *component trust-strip.css* | **38** |
| `--size-32` | *component chip.css* *component info-page.css* *component nav-tile.css* *component stepper.css* | **139** |
| `--size-34` | *component buy-box.css* *component empty-state.css* *component goal-tile.css* *component stepper.css* | **50** |
| `--size-38` | *component cart-drawer.css* *component checkout-form.css* *component quiz.css* *component trust-strip.css* | **48** |
| `--size-40` | *component auth-dialog.css* *component button.css* *component coach-cabinet.css* *component coach-clients.css* *component field.css* *component order-row.css* *component product-thumb.css* *component quiz.css* + 4 more | **143** |
| `--size-44` | *component account-shell.css* *component button.css* *component coach-clients.css* *component coach-order.css* *component coach-session.css* *component favourite.css* *component field.css* *component header.css* + 5 more | **143** |
| `--size-46` | *component auth-dialog.css* *component checkout-form.css* *component coach-cabinet.css* *component coach-verify.css* *component newsletter.css* *component search-overlay.css* *component skeleton.css* | **143** |
| `--size-52` | *component brand-logo.css* *component button.css* *component checkout-form.css* *component coach-order.css* *component coach-session.css* *component coach-verify.css* *component menu.css* *component order-placed.css* + 4 more | **143** |
| `--size-64` | *component button.css* *component order-placed.css* *component skeleton.css* | **143** |
| `--slate-300` | `--text-info` | **38** |
| `--slate-400` | `--mark-tier-silver` | **39** |
| `--slate-600` | `--text-info` | **38** |
| `--space-12` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component badge.css* *component banner.css* *component blog-card.css* *component brand-logo.css* + 71 more | **143** |
| `--space-16` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component banner.css* *component blog-card.css* *component brand-logo.css* *component breadcrumb.css* + 63 more | **143** |
| `--space-2` | *component account-shell.css* *component address-card.css* *component badge.css* *component banner.css* *component blog-card.css* *component buy-box.css* *component cart-drawer.css* *component cart-row.css* + 42 more | **143** |
| `--space-24` | *component account-shell.css* *component article.css* *component auth-dialog.css* *component banner.css* *component blog-card.css* *component button.css* *component buy-box.css* *component cart-drawer.css* + 34 more | **143** |
| `--space-32` | *component account-shell.css* *component article.css* *component auth-dialog.css* *component banner.css* *component checkout-form.css* *component client-row.css* *component coach-landing.css* *component coach-verify.css* + 10 more | **143** |
| `--space-4` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component availability.css* *component badge.css* *component banner.css* *component blog-card.css* + 52 more | **143** |
| `--space-40` | *component auth-dialog.css* *component cart-drawer.css* *component checkout-form.css* *component coach-landing.css* *component empty-state.css* *component info-page.css* *component pdp-tabs.css* *component quiz.css* + 2 more | **143** |
| `--space-8` | *component account-shell.css* *component address-card.css* *component article.css* *component auth-dialog.css* *component availability.css* *component badge.css* *component banner.css* *component blog-card.css* + 66 more | **143** |
...
| `--tint-orange-10` | `--elevation-action-hover` `--bg-action-selected` | **136** |
| `--tint-orange-15` | `--elevation-action-hover` `--ring-focus` | **143** |
| `--tint-orange-45` | `--elevation-knob-active` `--ring-focus` | **143** |
| `--tint-red-04` | `--bg-danger-soft` | **143** |
| `--tint-red-10` | `--ring-danger` | **143** |
| `--tint-red-30` | `--line-danger-soft` | **143** |
| `--tint-red-d-04` | `--bg-danger-soft` | **143** |
| `--tint-red-d-10` | **нікого** | **0** |
| `--tint-red-d-30` | `--ring-danger` `--line-danger-soft` | **143** |
| `--veil-dark-86` | `--veil-surface-mid` | **11** |
| `--veil-dark-90` | `--veil-page` | **143** |
| `--veil-dark-96` | `--veil-surface` | **11** |
| `--veil-ink-42` | `--veil-inverse` | **143** |
| `--veil-light-42` | `--veil-inverse` | **143** |
| `--veil-warm-86` | `--veil-surface-mid` | **11** |
| `--veil-warm-96` | `--veil-surface` | **11** |
| `--veil-white-90` | `--veil-page` | **143** |
| `--warm-100` | `--bg-sunken` | **143** |
| `--warm-150` | `--bg-inverse-soft` | **4** |
| `--warm-200` | `--bg-rule` `--line-hair` `--bg-hatch` | **143** |
| `--warm-300` | `--bg-track` `--line-strong` `--mark-inactive` | **143** |
| `--warm-400` | `--text-secondary` `--line-control-filled` | **143** |
| `--warm-50` | `--text-primary` `--text-body` `--bg-surface` `--bg-inverse` `--line-inverse` `--bg-photo-far` | **143** |
| `--warm-500` | `--text-muted` `--text-brandline` `--line-control-hover` | **143** |
| `--warm-600` | `--text-muted` `--text-brandline` `--line-control-hover` `--mark-faint` `--text-price-was` | **143** |
| `--warm-700` | `--text-secondary` `--line-control-filled` `--mark-disabled` | **143** |
| `--warm-750` | `--bg-track` `--line-strong` `--mark-inactive` | **143** |
| `--warm-800` | `--bg-rule` `--line-hair` `--bg-hatch` | **143** |
| `--warm-850` | `--bg-sunken` | **143** |
| `--warm-900` | `--bg-surface` | **143** |
| `--warm-950` | `--bg-page` `--line-onink` | **143** |
| `--white` | `--text-oninverse` `--text-onaction` `--bg-page` `--text-onmedia` `--ring-onink` `--bg-photo` `--text-photo-mark` `--line-onink` + 1 more | **143** |
