...
The product-voice layer for the wireframes — **rules, not mood**. Lives in a new `Voices/`
folder: `Voices/docs/` = md source of truth; `Voices/*.html` = research-style UA visualizations,
...
audit. Live pages: `Voices/voice.html`, `Voices/microcopy.html`.

**Two docs (source of truth, `Voices/docs/`):**
...
Competitor-voice evidence captured in `research/docs/competitive-analysis.md` (§Competitor Voice):
