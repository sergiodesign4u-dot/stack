...
| Was | Became | Why |
|---|---|---|
| `Voices/` | `voice/` | one address for the stage |
| `concept/` | `design/concept/` | `design/` is the roof of the whole visual half (stages 06-09) |
| `ui-visual/` | `design/` | same |
| `ui-visual/screens.html` | `design/overview.html` | a hub is always `overview.html` |
| `ui-visual/home.html` | `design/index.html` | `index.html` is the home page of the folder |
...
| `wireframes/_screens.md` and friends | `wireframes/docs/` | md sources live in `docs/` |
